...
# englishwords = ['lightning', 'scar', 'arms', 'birthmark', 'colour', 'palm', 'palm-frond', 'doctor', 'healer', 'nurse', 'medical practitioner', 'anthill', 'darn', 'glory', 'splendour', 'deliriousness', 'scabies', 'court', 'opening', 'open space', 'grabbing', 'buttermilk', 'crucifixion', 'nursing mother', 'healing', 'curing', 'eavesdropping', 'overhearig', 'support', 'America', 'American', 'secretary', 'child', 'daughter', 'son', 'African Ebony', 'fermentation', 'ringworm', 'umbilical cord', 'April', 'hide', 'pharmacy', 'apple', 'udder', 'December', 'player', 'dancer', 'game', 'toy', 'boxer', 'beating', 'train', 'trainer', 'exercise', 'root', 'type', 'gender', 'sex', 'perseverance', 'efficiency', 'bird', 'plane', 'aeroplane', 'helicopter', 'idea', 'black crow', 'soot', 'fledgling', 'corpse', 'dead body', 'dead bodies', 'remembrance', 'eraser', 'name', 'vicinity', 'biltong', 'despicable', 'knot', 'killer', 'murderer', 'moon', 'month', 'chance', 'first born', 'door', 'entrance', 'traveller', 'journey', 'madam', 'thorn', 'dagger', 'knife', 'bucket', 'cemetery', 'graveyard', 'sugar cane', 'lizard', 'fog', 'feather', 'life', 'soul', 'Saturday', 'vinegar', 'Thursday', 'Wednesday', 'Tuesday', 'farm', 'introduction', 'picture', 'photogragh', 'photographer', 'explanation', 'commentator', 'absenteeism', 'truant', 'February', 'snuff', 'suspicion', 'tax', 'taxpayer', 'receipt', 'slip', 'payslip', 'necktie', 'mouth-organ', 'leaf', 'turn', 'opportunity', 'foreman', 'boss', 'furrow', 'form', 'winter', 'hypocrite', 'breath', 'holiday', 'break', 'playtime', 'hair', 'bride', 'ground nut', 'hole', 'hero', 'heroine', 'frog', 'burial', 'funeral', 'flood', 'liar', 'jealousy', 'shortness', 'abbreviation', 'payment', 'thief', 'reward', 'vanity', 'fat', 'butter', 'oil', 'lotion', 'honey', 'margarine', 'hat', 'prayer', 'protector', 'protection', 'vow', 'granary', 'donor', 'donation', 'gift', 'present', 'talent', 'abate', 'abattoir', 'abdomen', 'abduction', 'ability', 'able', 'abscess', 'absence', 'abundance', 'academy', 'accent', 'accomodation', 'accountability', 'accused', 'accuser', 'acrophobia', 'actor', 'accusation', 'adansonia digitata', 'baobab', 'addition', 'accordion', 'addressee', 'adenoid', 'adjective', 'adjournment', 'adult', 'adulterer', 'adulteress', 'adultery', 'adversity', 'advertisement', 'advice', 'affiliation', 'Afrikaans', 'afternoon', 'age', 'agenda', 'agreement', 'agriculture', 'agronomy', 'agronomist', 'aim', 'air', 'alarm', 'albino', 'albizia anthelmintica', 'album', 'alcohol', 'algae', 'alkali', 'alliance', 'allurement', 'aloe', 'aluminium', 'ambassador', 'ambush', 'ammonia', 'ammonium sulphate', 'ammunition', 'amnesty', 'amount', 'amulet', 'analysis', 'anatomy', 'anatree', 'acacia albida', 'ancestor', 'ancestral spirits', 'animal', 'wild animal', 'angel', 'angle', 'anchor', 'ankle', 'annexation', 'answer', 'ant', 'anthill', 'ant-hill', 'anthrax', 'antibiotic', 'anticipation', 'anxiety', 'anvil', 'ape', 'apoplexy', 'apparatus', 'apparition', 'appeal', 'appearance', 'appendicitis', 'appendix', 'appetite', 'applause', 'application', 'appointment', 'apron', 'aquarium', 'Arab', 'arbitrator', 'architect', 'archeology', 'area', 'argument', 'arm', 'armpit', 'armament', 'arrangement', 'arrival', 'arrogance', 'arrow', 'artery', 'article', 'artisan', 'artist', 'arts', 'asbestos', 'Asia', 'Asian', 'ash', 'arrest', 'army', 'aroma', 'asking', 'aspect', 'assegai', 'assembly', 'assignment', 'assistant', 'assistance', 'association', 'asthma', 'astonishment', 'atom', 'Atlantic', 'atlas', 'atmosphere', 'attack', 'attacker', 'attempt', 'attention', 'attentiveness', 'attitude', 'attraction', 'auction', 'auctioneer', 'August', 'aunt', 'Australia', 'Australian', 'Austria', 'Austrian', 'authority', 'autumn', 'avocado', 'awl', 'axe', 'axle', 'axis', 'awareness', 'awakening']
